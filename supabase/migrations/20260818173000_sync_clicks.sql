...
-- Contamos apenas cliques únicos por IP a cada 24h para manter a consistência com a lógica de negócio
...
-- 3. Permissões estritas: apenas service_role pode executar
