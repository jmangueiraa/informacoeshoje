...
DECLARE
    new_user_id UUID;
    target_email TEXT := 'beatrizcosta.costa1994@gmail.com';
    target_pass TEXT := '20032023@Bia';
BEGIN
    ...
    VALUES (new_user_id, 'Beatriz Costa')
    ON CONFLICT (id) DO UPDATE SET full_name = 'Beatriz Costa';
