    ...
    for (let i = 0; i < imagesToProcess.length; i++) {
      ...
      try {
        ...
        try {
          ...
          if (!name || name.toLowerCase().includes("cliente") || name === "null" || name.toLowerCase() === "não identificado") {
            // Keep the Cliente XXXXX if generated by Gemini or generate locally if missing
