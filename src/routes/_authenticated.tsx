    ...
    <SidebarProvider>
      <div className="flex min-h-screen w-full bg-background relative">
        ...
        <main className="flex-1 overflow-y-auto flex flex-col">
          <header className="flex h-16 shrink-0 items-center gap-2 border-b px-4 bg-card/50 backdrop-blur-sm sticky top-0 z-20 sm:flex md:hidden" style={{ display: 'flex' }}>
